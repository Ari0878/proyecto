...
<head>
    ...
    <meta name="description" content="Sistema de gestión de trayectorias">
    <title>Lista de Trayectorias</title>
...
<body>
    <div class="container mt-5">
        <h2 class="mb-4">Lista de Trayectorias</h2>
                ...
                <tbody>
                    @foreach($data as $item)
                        <tr>
                            ...
                            <td>{{ $item['ruta_inicio'] }}</td>
                            <td>{{ $item['hora_final'] }}</td>
                            <td>{{ $item['ruta_final'] }}</td>
                        </tr>
                    @endforeach
                </tbody>
            </table>
