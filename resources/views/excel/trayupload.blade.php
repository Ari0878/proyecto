...
<head>
    ...
    <title>Excel Trayectoria</title>
    <!-- Bootstrap CSS (opcional) -->
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0/dist/css/bootstrap.min.css" rel="stylesheet">
</head>
<body>
    <div class="container mt-5">
        <h1 class="mb-4">Cargar archivo Excel Trayectoria</h1>

        <!-- Formulario para cargar el archivo -->
        <form action="{{ route('trayupload.excel') }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="mb-3">
